...
\begin{multicols}{2}
\begin{rSubsection}{Multi-threaded brainyquote.com Scraper}{}{Python, BeautifulSoup, Requests, sqlite3}{}
  \item Used threading to reduce time for scraping from hours to minutes by utilizing an iterative and modular approach.
  \item Stored results in sqlite3 database to integrate into a React.js website, which is currently in progress.
\end{rSubsection}
\columnbreak %---------------------------------------------------------------------------
